...
<body class="">
    ...
    <?php navigation($this->session->userdata('username')); ?>
    <!-- END NAVIGATION -->
                                        ...
                                        <div class="tab-pane fade active in padding-10 no-padding-bottom" id="s1">
                                            ...
                                            <div class="show-stat-microcharts">
                                                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                                    ...
                                                    <div class="easy-pie-chart txt-color-orangeDark" data-percent="<?php echo $avg; ?>" data-pie-size="50">
                                                        <span class="percent percent-sign"><?php echo $avg; ?></span>
                                                    </div>
                                ...
                                <div class="widget-body widget-hide-overflow no-padding">
                                    ...
                                    <div id="chat-container">
                                        ...
                                        <div class="chat-list-body custom-scroll">
                                            <ul id="chat-users">
                                                <li>
                                                    <a href="javascript:void(0);"><img src="<?php echo base_url('assests/'); ?>/img/avatars/5.png" alt="">Robin Berry <span class="badge badge-inverse">23</span><span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);"><img src="<?php echo base_url('assests/'); ?>/img/avatars/male.png" alt="">Mark Zeukartech <span class="state"><i class="last-online pull-right">2hrs</i></span></a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);"><img src="<?php echo base_url('assests/'); ?>/img/avatars/male.png" alt="">Belmain Dolson <span class="state"><i class="last-online pull-right">45m</i></span></a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);"><img src="<?php echo base_url('assests/'); ?>/img/avatars/male.png" alt="">Galvitch Drewbery <span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);"><img src="<?php echo base_url('assests/'); ?>/img/avatars/male.png" alt="">Sadi Orlaf <span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);"><img src="<?php echo base_url('assests/'); ?>/img/avatars/male.png" alt="">Markus <span class="state"><i class="last-online pull-right">2m</i></span> </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);"><img src="<?php echo base_url('assests/'); ?>/img/avatars/sunny.png" alt="">Sunny <span class="state"><i class="last-online pull-right">2m</i></span> </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);"><img src="<?php echo base_url('assests/'); ?>/img/avatars/male.png" alt="">Denmark <span class="state"><i class="last-online pull-right">2m</i></span> </a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div id="chat-body" class="chat-body custom-scroll">
                                        <ul>
                                            <li class="message">
                                                <img src="<?php echo base_url('assests/'); ?>/img/avatars/5.png" class="online" alt="">
                                            ...
                                            <li class="message">
                                                <img src="<?php echo base_url('assests/'); ?>/img/avatars/sunny.png" class="online" alt="">
                                                <div class="message-text">
                                                    <time>
                                                        2014-01-13
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($countries as $key => $value) {
                                                if ($first) {
                                                    ...
                                                    echo '<tr>';
                                                    ?>
                                                <td><a href="javascript:void(0);"><?php echo $key; ?></a></td>                             
