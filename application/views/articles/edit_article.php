                        ...
                        <div class="jarviswidget" id="wid-id-0" data-widget-deletebutton="false" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    <form class="smart-form" role="form" action="<?php echo site_url('/article/update_article'); ?>" method="POST" enctype="multipart/form-data">

                                        <fieldset>
                                            <section>
                                                <label class="label">Title</label>
                                                <label class="input">
                                                    <input name="article_title" type="text" value="<?php echo $values['article_title']; ?>">
                                                </label>
                                            </section>
                                            ...
                                            <section>
                                                ...
                                                <label class="textarea textarea-resizable">
                                                    <textarea rows="3" class="custom-scroll" name="article_description" id="article_description"><?php echo $values['article_description']; ?></textarea>
                                                </label>
                                            ...
                                            <section>
                                                ...
                                                <label class="textarea textarea-resizable">
                                                    <textarea rows="3" class="custom-scroll" name="article_content" id="article_content" ><?php echo $values['article_content']; ?></textarea>
                                                </label>
                                            </section>
                                            ...
                                            <section>
                                                ...
                                                <label class="input">
                                                    <input name="article_author" type="text" value="<?php echo $values['article_author']; ?>">
                                                </label>
                                            </section>
